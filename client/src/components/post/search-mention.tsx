...
interface ISearchMentionProps {

 

}
const SearchMentionDropDown = (props: ISearchMentionProps) => {
          ...
          <div className="relative max-w-lg w-96">
            ...
            {users.length > 0 ? (
              users
                .filter(
                  (user) =>
                    !currentUser!.followers.includes(user.username) &&
...
export default SearchMentionDropDown;